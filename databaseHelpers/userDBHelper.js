 ...
 */
function registerUserInDB(email, password, firstname, lastname, role,  registrationCallback){

  //create query using the data in the req.body to register the user in the db
  const registerUserQuery = `INSERT INTO users (email, password, firstname, lastname, role, grant_type) VALUES ('${email}', SHA('${password}'), '${firstname}', '${lastname}', '${role}', 'password')`
